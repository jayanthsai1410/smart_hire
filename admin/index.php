<?php
session_start(); //Database Configuration File
...
<head>
    ...
    <meta name="description" content="EasyHire.">
    <meta name="author" content="PHPGurukul">
    <!-- App title -->
    <title>EasyHire | Admin Panel</title>
    <!-- App css -->
    <link href="assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" /> <!-- Include the Bootstrap CSS file -->
...
<body class="bg-transparent">
                        ...
                        <div class="m-t-40 account-pages">
                            <div class="text-center account-logo-box">
                                <h2 class="text-uppercase">
                                    <span style="color: black;">Easy</span><span style="color: #608bd1;">Hire</span>
                                    </a>
                                </h2>
                            ...
                            <div class="account-content">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <a href="forgot-password.php"></i> Register</a>
                                    <hr>
                                    <div class="form-group">
                                        <div class="col-xs-12">
    ...
    <script src="assets/js/bootstrap.min.js"></script> <!-- Include the Bootstrap JS file -->
